...
export function addSoftCurrency(profile, amount) {
...
export function ensureLevelProgress(profile, totalLevels) {
...
export function recordLevelCompletion(profile, levelId, stars, score, totalLevels, comboAchieved, efficiencyAchieved) {
...
function normalizeLevelProgress(progress) {
    const normalized = {};
